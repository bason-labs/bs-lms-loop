...
## Summary (≤ 132 chars)
Auto-progress your Open edX (HUTECH eLearning) lessons: play videos to completion, archive docs, and advance — hands-free.
...
Built and tested for HUTECH eLearning. Open source, zero dependencies.
...
|------|------------------------|
| Host access to `*.hutech.edu.vn` | Content scripts must read each lesson and click Next on the HUTECH eLearning (Open edX) site, including its cross-origin lesson iframe, to advance the course. |
...
Automate progression through an Open edX (HUTECH eLearning) course by handling each
